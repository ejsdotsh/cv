...
\begin{document}
    ...
    \sectiontitle{links}
    \sectioncontent{
        \faIcon{github}\hspace{2mm} {https://github.com/ejsdotsh} \\
        % \href{https://github.com/ejsdotsh}{https://github.com/ejsdotsh} \\
        \faIcon{linkedin-in}\hspace{2.1mm} {https://linkedin/in/ejsdotsh} \\
        % \href{https://linkedin.com/in/ejsdotsh}{https://linkedin/in/ejsdotsh} \\
        \faIcon{link}\hspace{1.8mm} {https://ejs.sh}
        % \href{https://ejs.sh}{https://ejs.sh}
    }
