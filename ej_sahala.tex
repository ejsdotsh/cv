...
\newfontfamily\titlethin{Ubuntu Thin}
...
\newcommand{\certification}[2]{
    \textcolor{black!70}{\small#1} \hfill \small#2 \\
    % \vspace{1.5mm}
}
...
\begin{document}
    ...
    \sectioncontent{
        ...
        \begin{itemize}
            ...
            % \item CLOS/spine-leaf topologies, Ethernet, QoS, SDN, VPC, Segment Routing
            % \item SDN, VPC, Segment Routing
    ...
    \sectioncontent{
      ...
      \begin{itemize}
        ...
        % \item Designed and rebuilt network edge:
    ...
    \begin{itemize}
        % \item Planning, design, build, and operation of
